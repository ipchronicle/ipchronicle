...
case "$distribution" in
  ...
  centos-stream-9) image="quay.io/centos/centos:stream9@sha256:e389f09f8af8baade5be5de6dbf70d8b5975ddc54641858f35552ea3c98ac872"; expected_id=centos; version_prefix=9; init_system=systemd ;;
  centos-stream-10) image="quay.io/centos/centos:stream10@sha256:ed84a6789c59b1b132e7aa5994d98135938b3af329a855ff85be083a0956cb3e"; expected_id=centos; version_prefix=10; init_system=systemd ;;
