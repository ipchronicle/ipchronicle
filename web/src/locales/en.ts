export const en = {
  translation: {
    ...
    status: {
      ...
      healthyDetail: "The center API and all three databases are ready.",
    ...
    systemSettings: {
      ...
      logRetention: {
        ...
        detail:
          "Control how long uploaded Agent logs remain available for diagnosis. This storage is independent from configuration and probe history.",
        loadFailed: "Log retention settings could not be loaded",
        retry: "Retry",
        logicalUsage: "Logical usage",
        records: "Log events",
        lastCleanup: "Last cleanup",
        lastDeleted: "Last deleted",
        never: "Not run yet",
        cleanupFailed: "The last log cleanup failed",
        cleanNow: "Clean now",
        ...
        save: "Save and apply",
        invalid: "The log retention values are invalid.",
        saved: "Log retention was saved and applied.",
        cleaned: "Log cleanup completed and removed {{count}} events.",
      },
      release: {
    ...
    nodes: {
      ...
      batch: {
        ...
        selectVisible: "Select all filtered nodes",
        selected: "{{count}} selected",
        clear: "Clear selection",
        probe: "Batch probe",
        logs: "Set log level",
        logsDetail:
          "Each node applies the new log level after receiving its configuration.",
        accepted: "Accepted",
        skipped: "Skipped",
        failed: "Failed",
        disabled: "Node disabled or removed",
        offline: "Node offline",
        noAddresses: "No available public IPs for this node",
        noSelection: "No IPs selected",
        working: "Processing nodes",
      },
      actions: {
        title: "Node actions",
    ...
    nodeDetail: {
      ...
      settings: {
        ...
        logs: {
          ...
          detail:
            "Choose the minimum severity retained locally and uploaded to Center. Changing this does not delete existing logs.",
        },
        agent: {
          title: "Agent",
    ...
    logs: {
      ...
      detail:
        "Filter Agent runtime events by node, request, and task, then inspect failed responses and timing.",
      center: "Center",
      filters: {
        title: "Filter logs",
        detail:
          "Filters only change this view; they do not change the collection level on any node.",
        from: "From",
        to: "To",
        node: "Node",
        allNodes: "All nodes",
      ...
      level: { error: "Error", warn: "Warning", info: "Info", debug: "Debug" },
      list: {
        title: "Log events",
        live: "New events are fetched every 5 seconds.",
        paused: "Automatic refresh is paused.",
        pause: "Pause refresh",
        resume: "Resume refresh",
        retry: "Retry",
        refreshFailed: "Automatic refresh failed: {{error}}",
      ...
      entry: {
        title: "Log details",
        loading: "Loading the complete event.",
        loadFailed: "The log details could not be loaded.",
        occurredAt: "Occurred",
        receivedAt: "Received by Center",
        level: "Level",
        component: "Component",
        eventType: "Event type",
        node: "Node",
        ...
        duration: "Duration",
        rateLimitHeaders: "Rate-limit response headers",
        milliseconds: "{{count}} ms",
        responseBody: "Failed response body",
        responseMeta: "{{count}} bytes",
        truncated: "truncated",
        notAvailable: "Not available",
      },
      failure: {
      ...
      events: {
        "agent-started": "Agent control loop started",
        "configuration-applied": "Agent configuration applied",
        "poll-failed": "Center control poll failed",
        "poll-rejected": "Center rejected the control poll",
        "poll-succeeded": "Center control poll succeeded",
        "fetch-failed": "Configuration request failed",
        "fetch-rejected": "Center rejected the configuration request",
        "fetch-succeeded": "Configuration request succeeded",
        "snapshot-too-large": "Agent configuration response was too large",
        "snapshot-invalid": "Agent configuration response was invalid",
        "revision-mismatch": "Agent configuration revision did not match",
        "service-request-failed": "Public address service request failed",
        "service-request-succeeded": "Public address service request succeeded",
        "address-check-failed": "Public address check failed",
        "address-confirmed": "Public address confirmed",
        "provider-request-failed": "IP quality provider request failed",
        "provider-request-succeeded": "IP quality provider request succeeded",
        "provider-response-invalid": "IP quality provider response was invalid",
        "run-started": "Complete probe started",
        "run-skipped": "Complete probe skipped",
        "run-completed": "Complete probe completed",
        "target-succeeded": "Public IP quality probe succeeded",
        "target-failed": "Public IP quality probe failed",
        "artifact-upload-failed": "Probe result upload failed",
        "artifact-upload-rejected": "Center rejected the probe result",
        "artifact-upload-succeeded": "Probe result upload succeeded",
        "artifact-receipt-invalid":
          "Center returned an invalid probe result receipt",
        "upload-failed": "Agent log upload failed",
        "upload-rejected": "Center rejected the Agent log upload",
        "upload-receipt-invalid":
          "Center returned an invalid Agent log receipt",
        "events-dropped": "Some Agent logs were dropped before upload",
        "update-failed": "Agent update failed",
        "manifest-request-invalid":
          "Agent release manifest request was invalid",
        "manifest-download-failed": "Agent release manifest download failed",
        "manifest-read-failed":
          "Agent release manifest response could not be read",
        "manifest-too-large": "Agent release manifest response was too large",
        "manifest-download-rejected":
          "Agent release manifest download was rejected",
        "manifest-invalid": "Agent release manifest was invalid",
        "manifest-download-succeeded":
          "Agent release manifest download succeeded",
        "artifact-request-invalid": "Agent binary request was invalid",
        "artifact-download-failed": "Agent binary download failed",
        "artifact-download-rejected": "Agent binary download was rejected",
        "artifact-download-succeeded": "Agent binary download succeeded",
      },
    },
    errors: {
