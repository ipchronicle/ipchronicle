...
DROP INDEX network_egresses_proxy_idx;
DROP INDEX network_egresses_node_idx;
DROP INDEX network_egresses_proxy_reference_idx;

ALTER TABLE network_egresses RENAME TO network_egresses_v17;
...
SELECT id, node_id, name, kind, family, interface_name, source_address, proxy_id,
       enabled, available, automatic, lightweight_interval_seconds,
       probe_on_address_change, created_at, updated_at
FROM network_egresses_v17;

DROP TABLE network_egresses_v17;
