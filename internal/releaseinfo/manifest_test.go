...
func TestParseManifestAndSelectAgentArtifact(t *testing.T) {
	manifestJSON := `{
      ...
      "agentCapabilities":["address-observation-v1","agent-update-v1","complete-probe-v1","configuration-v5","control-v1","network-inventory-v1","sync-wakeup-v1"],
      "artifacts":[
